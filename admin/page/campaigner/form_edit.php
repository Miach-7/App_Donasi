...
$idCampaigner = $_GET['id_campaigner'];
$QueryEdit = mysqli_query($koneksi, "SELECT * FROM tbl_campaigner WHERE id_campaigner = '$idCampaigner'");
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-header-action">
              <a href="main.php" class="btn btn-danger">Kembali ke Daftar Campaigner <i
          ...
          <div class="card-body">
            <form class="form-horizontal" action="aksi_edit.php" method="post">
              ...
              <div class="form-group">
                <label for="nama_campaigner" class="col-sm-4 control-label">Nama Campaigner</label>
                <div class="col-sm-10">
